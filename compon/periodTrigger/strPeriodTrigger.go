...
func newStrPeriodTrigger(key string, intervalNs int64) *strPeriodTrigger {
	model := new(strPeriodTrigger)
	model.Key = key
...
func (c *strPeriodTrigger) Check(ts int64) TriggerState {
	result := TriggerState{}
